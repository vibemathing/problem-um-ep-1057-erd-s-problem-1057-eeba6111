...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1057-erd-s-problem-1057-eeba6111-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1057"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1057-erd-s-problem-1057-eeba6111-v1",
      "problem_contract_sha256": "afb07692ed007c384c86aaceadc5a56c6789798d70fcf1e90628081eb69139a1",
      "problem_id": "problem:um-ep-1057-erd-s-problem-1057-eeba6111",
      "route_id": "route:um-ep-1057-erd-s-problem-1057-eeba6111-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1057-erd-s-problem-1057-eeba6111-source-fidelity-01",
      "graph_id": "graph:um-ep-1057-erd-s-problem-1057-eeba6111-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1057-erd-s-problem-1057-eeba6111-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1057-erd-s-problem-1057-eeba6111-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $C(x)$ count the number of Carmichael numbers in the interval $[1,x]$. Is it true that $C(x)=x^{1-o(1)}$?"
          },
          "statement_sha256": "c3a1f8ec74e7c0a09d971ff6eeaacafccf493d6e95403ddce33fd559a1b60816"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1057-erd-s-problem-1057-eeba6111-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1057-erd-s-problem-1057-eeba6111-root",
      "route_id": "route:um-ep-1057-erd-s-problem-1057-eeba6111-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1057-df60a794dc88",
        "url": "https://www.unsolvedmath.com/problems/EP-1057"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
